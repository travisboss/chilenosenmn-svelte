...
<section class="container mx-auto flex flex-wrap justify-around">
	{#each cards as card}
		<div class="shadow-md rounded-md overflow-hidden m-4 flex-3 lg:flex-2">
			<img src={card.img} class="w-96 h-56" alt="" />

			<div class="p-4 flex justify-center flex-col">
				<h5 class="text-xl font-semibold mb-2 dark:text-white text-center capitalize">
					{card.title}
				</h5>

				<!-- <p class="mb-4 dark:text-white">{card.text}</p> -->
